...
void dance_33_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state.step) {
        case SINGLE_TAP: register_code16(RALT(KC_E)); break;
        case SINGLE_HOLD: register_code16(LALT(LSFT(KC_2))); break;
        case DOUBLE_TAP: register_code16(RALT(KC_E)); register_code16(RALT(KC_E)); break;
        case DOUBLE_SINGLE_TAP: tap_code16(RALT(KC_E)); register_code16(RALT(KC_E));
    }
}
...
void dance_33_reset(qk_tap_dance_state_t *state, void *user_data) {
    wait_ms(10);
    switch (dance_state.step) {
        case SINGLE_TAP: unregister_code16(RALT(KC_E)); break;
        case SINGLE_HOLD: unregister_code16(LALT(LSFT(KC_2))); break;
        case DOUBLE_TAP: unregister_code16(RALT(KC_E)); break;
        case DOUBLE_SINGLE_TAP: unregister_code16(RALT(KC_E)); break;
    }
    dance_state.step = 0;
}
